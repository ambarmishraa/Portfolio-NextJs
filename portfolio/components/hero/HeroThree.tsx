...
const HeroThree = () => {
    return (
        <section className="relative w-full h-screen overflow-hidden bg-black">
            ...
            <div className="absolute bottom-0 left-0 w-full h-[100%] bg-black z-20" />


            {/* Row 2 (Bottom overlay with stacked text) */}
            <div className="absolute bottom-0 left-0 w-full h-[75%] bg-black z-20 flex flex-col items-center justify-end px-10 pb-6">
